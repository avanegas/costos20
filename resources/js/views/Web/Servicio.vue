    ...
    <div class="row">
        <div class="col-md">
            ...
            <div class="form-group row m-0 mt-2 mb-2">
                <h5 class="col-8"><i class="fas fa-home"></i> Arquitectura <small style="color:rgb(51,115,255);">&nbsp.&nbsp.&nbsp&nbspEstudio, Diseño, Construcción, Fiscalización, otros.</small></h5>
                <div class="col-4 p-0">
                    <input
                        type="search"
