    ...
    <div class="row">
        <div class="col-md">
            <div class="form-group row mb-3 mt-3">
                <h5 class="col-6">{{action}} Grupo de Actividad</h5>
    ...
    export default {
        ...
        data() {
            return {
                ...
                isProcessing: false,
                initializeURL: `/api/groups/create`,
                storeURL: `/api/groups`,
                action: 'Create'
            }
        },
        created() {
            if(this.$route.meta.mode === 'edit') {
                this.initializeURL = `/api/groups/${this.$route.params.id}/edit`
                this.storeURL = `/api/groups/${this.$route.params.id}?_method=PUT`
                this.action = 'Update'
            }
        ...
        methods: {
            ...
            remove() {
                del(`/api/groups/${this.$route.params.id}`).then((res) => {
                    Flash.setSuccess('Ha eliminado correctamente el grupo de actividad!')
                    this.$router.back()
                });
            }
        }
